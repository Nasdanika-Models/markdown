 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.markdown.impl.TableCellImpl#getOpeningMarker <em>Opening Marker</em>}</li>
 *   <li>{@link org.nasdanika.models.markdown.impl.TableCellImpl#getText <em>Text</em>}</li>
 *   <li>{@link org.nasdanika.models.markdown.impl.TableCellImpl#getClosingMarker <em>Closing Marker</em>}</li>
 *   <li>{@link org.nasdanika.models.markdown.impl.TableCellImpl#getAlignment <em>Alignment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableCellImpl extends NodeImpl implements TableCell {
	/**
	 ...
	 * @ordered
	 */
	protected static final TableCellAlignment ALIGNMENT_EDEFAULT = TableCellAlignment.LEFT;
	...
	public String getOpeningMarker() {
		return (String)eDynamicGet(MarkdownPackage.TABLE_CELL__OPENING_MARKER, MarkdownPackage.Literals.TABLE_CELL__OPENING_MARKER, true, true);
	}
	...
	public void setOpeningMarker(String newOpeningMarker) {
		eDynamicSet(MarkdownPackage.TABLE_CELL__OPENING_MARKER, MarkdownPackage.Literals.TABLE_CELL__OPENING_MARKER, newOpeningMarker);
	}
	...
	public String getText() {
		return (String)eDynamicGet(MarkdownPackage.TABLE_CELL__TEXT, MarkdownPackage.Literals.TABLE_CELL__TEXT, true, true);
	}
	...
	public void setText(String newText) {
		eDynamicSet(MarkdownPackage.TABLE_CELL__TEXT, MarkdownPackage.Literals.TABLE_CELL__TEXT, newText);
	}
	...
	public String getClosingMarker() {
		return (String)eDynamicGet(MarkdownPackage.TABLE_CELL__CLOSING_MARKER, MarkdownPackage.Literals.TABLE_CELL__CLOSING_MARKER, true, true);
	}
	...
	public void setClosingMarker(String newClosingMarker) {
		eDynamicSet(MarkdownPackage.TABLE_CELL__CLOSING_MARKER, MarkdownPackage.Literals.TABLE_CELL__CLOSING_MARKER, newClosingMarker);
	}
	...
	public TableCellAlignment getAlignment() {
		return (TableCellAlignment)eDynamicGet(MarkdownPackage.TABLE_CELL__ALIGNMENT, MarkdownPackage.Literals.TABLE_CELL__ALIGNMENT, true, true);
	}
	 ...
	 */
	@Override
	public void setAlignment(TableCellAlignment newAlignment) {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MarkdownPackage.TABLE_CELL__OPENING_MARKER:
				return getOpeningMarker();
			case MarkdownPackage.TABLE_CELL__TEXT:
				return getText();
			case MarkdownPackage.TABLE_CELL__CLOSING_MARKER:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MarkdownPackage.TABLE_CELL__CLOSING_MARKER:
				...
				return;
			case MarkdownPackage.TABLE_CELL__ALIGNMENT:
				setAlignment((TableCellAlignment)newValue);
				return;
		}
